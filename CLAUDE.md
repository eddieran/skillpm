...
Universal package manager for AI agent skills — install once, inject into Claude, Codex, Gemini, Copilot, OpenCode, Kiro, OpenClaw, and more.
...
- `CLAUDE.md` (this file) — repo orientation
