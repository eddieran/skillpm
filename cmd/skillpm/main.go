...
func newScheduleCmd(newSvc func() (*app.Service, error), jsonOutput *bool) *cobra.Command {
	...
	installCmd := &cobra.Command{
		...
		Aliases: []string{"add", "create", "on", "enable", "set", "start", "update", "resume"},
	...
	listCmd := &cobra.Command{
		Use:     "list",
		Aliases: []string{"ls", "status", "st", "show", "get", "info"},
	...
	removeCmd := &cobra.Command{
		Use:     "remove",
		Aliases: []string{"rm", "off", "disable", "stop", "del", "delete", "uninstall", "clear", "pause"},
