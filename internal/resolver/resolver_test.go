...
func TestParseRef(t *testing.T) {
	tests := []struct {
		...
		// GitLab bare URL
		{"https://gitlab.com/acme-team/acme-skills", ParsedRef{Source: "acme-team_acme-skills", Skill: ".", IsURL: true, URL: "https://gitlab.com/acme-team/acme-skills.git", Branch: ""}, false},
		// GitLab with .git suffix
		{"https://gitlab.com/acme-team/acme-skills.git", ParsedRef{Source: "acme-team_acme-skills", Skill: ".", IsURL: true, URL: "https://gitlab.com/acme-team/acme-skills.git", Branch: ""}, false},
